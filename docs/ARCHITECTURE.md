...
| Model Provider | Post-MVP 확장 시점 | API 사용성, 비용, AWS 확장성 |
| 장기 저장 방식 | Post-MVP 확장 시점 | 로컬 개발 편의성, 이후 S3 확장 가능성 |
...
## 18. Observed Baseline Evidence

2026-03-13 기준 로컬 데모 실행 결과는 아래와 같습니다.
...
다만 이 수치는 짧고 구조가 명확한 샘플 계약 문서에 대한 controlled baseline 결과입니다. 따라서 현재 아키텍처의 핵심 메시지는 "일반화된 최고 성능"이 아니라 "근거 기반 문서 QA 흐름과 품질 루프를 end-to-end로 검증했다"에 가깝습니다.
